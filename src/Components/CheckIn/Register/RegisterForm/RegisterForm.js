...
const registerForm = (props) => (
  <form className="register" autoComplete="off">
    ...
    <label htmlFor="school">Your current school:</label>
    <input type="text"
      name="school"
    ...
    <label htmlFor="id">Your graduation year:</label>
    <input type="number"
      name="year"
    ...
    <label htmlFor="parents">Parent/guardian name(s):</label>
    <input type="text"
      name="parents"
    ...
    <label htmlFor="parentPhone">Parent/guardian cell phone number(s):</label>
    <input type="text"
      name="parentPhone"
